    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <form method="post" action="{{route('dashboard-location.update', $location->id)}}" class="p-6 bg-white border-b border-gray-200">@csrf @method('put')
                    @csrf
                   <div class="flex -mx-4 mb-6">
                       <div class="flex-1 px-4">
                            <label for="name" class="mseproperty-label">Locaton Name <span class="required-text">*</span></label>
                            <input type="text" class="mseproperty-input" id="name" name="name" value="{{$location->name}}" required>
                       ...
                       <div class="flex-1 px-4">
                            ...
                            <input type="text" class="mseproperty-input" id="name_bn" name="name_bn" value="{{$location->name_bn}}" required>
