...
<x-guest-layout>
    <div class="relative z-10 pt-48 pb-52 bg-cover bg-center" style="background-image: url(/img/house5.jpeg)">
    ...
    <div class="container text-center pt-14">
        ...
        <div class="relative mt-10 mb-14 bg-cover rounded-xl py-24 bg-center"
             style="background-image: url('/img/house1.jpeg')">
    ...
    <div class="container pt-14">
        <div class="flex justify-between ">
            ...
            <div class="flex-1 ml-10">
                <img class="rounded" src="/img/house4.jpeg" alt="">
            </div>
        </div>
    </div>
    <div class="container pt-14">
